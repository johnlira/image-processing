...
const _env = z.object({
  ...
  AWS_REGION: z.string().min(1, ".env is invalid: AWS_REGION not defined").default("us-east-1"),
  AWS_ACCESS_KEY_ID: z
    .string()
  ...
  AWS_SECRET_ACCESS_KEY: z
    ...
    .default("test"),
  S3_BUCKET_NAME: z.string().min(1, "S3_BUCKET_NAME is required").default("images-bucket"),
});
